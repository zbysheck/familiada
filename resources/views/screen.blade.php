    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            for (var i=0;i<10500;i++) {
                $("body").append(`<a class='cl' id='dot${i}'></a>`);
        ...
        function setCharacter(gridX, gridY, char){
            let [x, y] = translateToGrid(gridX, gridY);
            charArray = getCharArray(char);
            //lightUp(x,y);
        ...
        function translateToGrid(gridX, gridY){
            return [gridX * 5, gridY * 7]
        }

        function getCharArray(char) {
            //console.log(char)
            chars = {
                ' ': [
                    "     ",
            ...
            chosen = chars[char] ? chars[char] : chars[' ']
